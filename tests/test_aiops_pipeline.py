...
def test_pipeline_processes_records(tmp_path):
    ...
    data_file.write_text(
        '[{"timestamp": "2026-09-20T10:00:00", '
        '"service": "payment-service", "response_time_ms": 120, '
        '"cpu_percent": 42, "memory_percent": 51, "log_level": "INFO", '
        '"message": "Payment request processed successfully"}, '
        '{"timestamp": "2026-09-20T10:05:00", '
        '"service": "payment-service", "response_time_ms": 610, '
        '"cpu_percent": 75, "memory_percent": 70, "log_level": "ERROR", '
        '"message": "Payment service timeout"}]',
        encoding="utf-8",
    )
